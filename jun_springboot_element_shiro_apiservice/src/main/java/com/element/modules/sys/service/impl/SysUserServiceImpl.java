...
public class SysUserServiceImpl extends ServiceImpl<SysUserMapper, SysUserEntity> implements SysUserService {
    ...
    @Override
    public PageUtils listUserByPage(Map<String, Object> params) {
    ...
    @Override
    public List<Long> listMenuIdByCreateUserId(Long userId) {
        return baseMapper.listMenuIdByCreateUserId(userId);
    }
    ...
    private void checkRole(SysUserEntity user) {
        ...
        //查询用户创建的角色列表
        List<Long> roleIdList = sysRoleService.listRoleIdByCreatedUserId(user.getCreateUserId());
        //判断是否越权
