...
public class Result<T> implements Serializable {
    ...
    public static<T> Result<T> failure(){
        return failure(StatusCode.SUCCESS.getMessage());
    }
    ...
    public static<T> Result<T> failure(String message,T data){
        return failure(StatusCode.FAILURE.getCode(),message,data);
    }
    ...
    public static<T> Result<T> failure(int code ,String message){
        return failure(StatusCode.FAILURE.getCode(),message,null);
    }
    ...
    public static<T> Result<T> decide(boolean b){
        return decide(b,StatusCode.SUCCESS.getMessage(),StatusCode.FAILURE.getMessage());
    }
