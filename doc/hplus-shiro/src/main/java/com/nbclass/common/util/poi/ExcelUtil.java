package com.nbclass.common.util.poi;
...
import com.nbclass.common.annotation.Excel;
import com.nbclass.common.annotation.Excel.ColumnType;
import com.nbclass.common.annotation.Excel.Type;
import com.nbclass.common.constant.CoreConst;
import com.nbclass.common.annotation.Excels;
...
import com.nbclass.common.util.ReflectUtils;
import com.nbclass.common.util.ResultUtil;
import com.nbclass.common.util.SpringUtils;
...
public class ExcelUtil<T> {
	...
	public ResponseVo<?> exportExcel() {
		...
		try {
			...
			throw new HtException("导出Excel失败，请联系网站管理员！");
		} finally {
			if (wb != null) {
				try {
					wb.close();
	...
	public String getAbsoluteFile(String filename) {
		String downloadPath = PropertiesUtil.getString(CoreConst.WORK_DIR_KEY) + "/" + filename;
