						...
						columns : [
								...
								},
								{
									...
									formatter : function(v, r, i) {
										let html = "<a href='/sys/role/edit/#id#' onclick='ConTabSham.add(event,this);'>#text#</a>";
										html = html.replace('#id#', r.id).replace('#text#', v);
										return html;
									}
								},
								{
...
function show_tab_frame(evt, that) {
	console.log(evt, that);
	ConTab.add(evt, that);
}
