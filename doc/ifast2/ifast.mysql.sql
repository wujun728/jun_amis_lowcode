...
CREATE TABLE `wx_mp_config` (
  ...
  `app_yype` int(11) NOT NULL COMMENT '公众号类型： 1.订阅号 2.服务号 3.企业号 4.小程序 5. 测试号',
...
CREATE TABLE `wx_mp_fans` (
  ...
  `tagid_ist` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `wx_mp_wechat_keys` (
  ...
  `media_id` varchar(50) DEFAULT NULL COMMENT '素材_id',
  ...
  `news_id` bigint(20) DEFAULT NULL COMMENT '图文素材_id',
