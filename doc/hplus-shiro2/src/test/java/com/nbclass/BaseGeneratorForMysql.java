...
public class BaseGeneratorForMysql {
	...
	public static void main(String[] args) {
		...
		dsc.setUrl("jdbc:mysql://127.0.0.1:3306/hplus-shiro?useUnicode=true&characterEncoding=utf8&useSSL=false&serverTimezone=GMT%2B8");
		...
		// 公共父类
		// strategy.setSuperControllerClass("com.nbclass.modules.base.BaseController");
		// 写于父类中的公共字段
