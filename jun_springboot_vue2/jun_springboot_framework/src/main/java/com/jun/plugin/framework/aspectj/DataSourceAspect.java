...
import com.jun.plugin.common.enums.DataSourceType;
import com.jun.plugin.framework.datasource.DynamicDataSourceContextHolder;
...
public class DataSourceAspect
{
    ...
    @Around("execution(* com.jun.plugin..*ServiceImpl.*(..))")
