...
import xin.guaika.cloud.spring.boot.masterslave.SpringBootMasterSlaveRuleConfigurationProperties;
import xin.guaika.cloud.spring.boot.sharding.SpringBootShardingRuleConfigurationProperties;
