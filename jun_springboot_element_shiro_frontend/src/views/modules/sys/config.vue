<template>
  <div class="app-container">
      ...
      <div class="filter-content">
        <el-form :inline="true" :model="listQuery" size="small" label-width="100px">
          <el-form-item label="输入搜索：">
            <el-input v-model="listQuery.paramKey" class="input-width" placeholder="参数名称" clearable></el-input>
          </el-form-item>
        </el-form>
      </div>
    </el-card>
    <el-card class="operate-container" shadow="never">
      ...
      <el-button size="small" class="btn-add" type="primary" @click="addOrUpdateHandle()">新增参数</el-button>
    </el-card>
...
<script>
  import { fetchList, deleteConfig } from '@/api/sys/config'
