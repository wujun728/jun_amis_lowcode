...
insert into sys_dict_type values(11, '菜单类型', 'sys_menu_type',       '0', 'admin', sysdate(), '', null, '菜单类型列表');
...
insert into sys_dict_data values (110, 0, '其他', '0', 'sys_oper_type', '', 'default', 'N', '0', 'admin', sysdate(), '', null, '清空操作');
insert into sys_dict_data values (111, 3, '新增', '3', 'sys_oper_type', '', 'info', 'N', '0', 'admin', sysdate(), '', null, '新增操作');
insert into sys_dict_data values (112, 4, '修改', '4', 'sys_oper_type', '', 'info', 'N', '0', 'admin', sysdate(), '', null, '修改操作');
insert into sys_dict_data values (113, 5, '删除', '5', 'sys_oper_type', '', 'danger', 'N', '0', 'admin', sysdate(), '', null, '删除操作');
insert into sys_dict_data values (114, 9, '授权', '9', 'sys_oper_type', '', 'danger', 'N', '0', 'admin', sysdate(), '', null, '授权操作');
insert into sys_dict_data values (115, 7, '导出', '7', 'sys_oper_type', '', 'warning', 'N', '0', 'admin', sysdate(), '', null, '导出操作');
insert into sys_dict_data values (116, 8, '导入', '8', 'sys_oper_type', '', 'warning', 'N', '0', 'admin', sysdate(), '', null, '导入操作');
insert into sys_dict_data values (117, 10, '强退', '10', 'sys_oper_type', '', 'danger', 'N', '0', 'admin', sysdate(), '', null, '强退操作');
insert into sys_dict_data values (118, 11, '生成代码', '11', 'sys_oper_type', '', 'info', 'N', '0', 'admin', sysdate(), '', null, '生成操作');
insert into sys_dict_data values (119, 6, '清空数据', '6', 'sys_oper_type', '', 'danger', 'N', '0', 'admin', sysdate(), '', null, '清空操作');
insert into sys_dict_data values (120, 1, '查询', '1', 'sys_oper_type', '', 'warning', 'N', '0', 'admin', sysdate(), '', null, '查询');
insert into sys_dict_data values (121, 2, '保存', '2', 'sys_oper_type', '', 'info', 'N', '0', 'admin', sysdate(), '', null, '保存');
insert into sys_dict_data values (122, 12, '执行任务', '12', 'sys_oper_type', '', '', 'N', '0', 'admin', sysdate(), '', null, '执行任务');
insert into sys_dict_data values (123, 13, '解锁账户', '13', 'sys_oper_type', '', 'info', 'N', '0', 'admin', sysdate(), '', null, '解锁账户');
insert into sys_dict_data values (18, 1, '目录', 'M', 'sys_menu_type', '', 'success', 'Y', '0', 'admin', sysdate(), '', null, '菜单类型目录');
insert into sys_dict_data values (19, 2, '菜单', 'C', 'sys_menu_type', '', 'primary', 'N', '0', 'admin', sysdate(), '', null, '菜单类型菜单');
insert into sys_dict_data values (20, 3, '权限', 'F', 'sys_menu_type', '', 'warning', 'N', '0', 'admin', sysdate(), '', null, '菜单类型权限');
...
create table gen_table_column (
  ...
  is_export         char(1)                                    comment '是否导出字段（1是）',
