...
import com.ruoyi.framework.aspectj.lang.enums.UserStatus;
...
public class LoginService extends CommonService {
	...
	public User login(String username, String password) {
		...
		//设置用户角色
		user.setRoles(roleService.selectRolesByUserId(String.valueOf(user.getUserId())));
	...
	public void recordLoginInfo(User user) {
		String sql = "update sys_user set login_ip = ?, login_date = sysdate() where user_id = ?";
		db.execute(sql, new Object[]{ShiroUtils.getIp(), user.getUserId()});
	}
}