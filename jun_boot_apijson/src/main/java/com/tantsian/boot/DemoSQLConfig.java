...
import com.tantsian.boot.model.Stone;
...
public class DemoSQLConfig extends APIJSONSQLConfig {
	...
	static {
		...
		DEFAULT_SCHEMA = "thea";  //TODO 默认模式名，改成你自己的，默认情况是 MySQL: sys, PostgreSQL: public, SQL Server: dbo, Oracle:
...
//			}
	...
	public String getDBVersion() {
		if (isMySQL()) {
			return "8.0.11"; //"8.0.11"; //TODO 改成你自己的 MySQL 或 PostgreSQL 数据库版本号 //MYSQL 8 和 7 使用的 JDBC 配置不一样
		}
		if (isPostgreSQL()) {
